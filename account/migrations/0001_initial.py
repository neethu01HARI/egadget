    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Mobile Phone', 'Mobile Phone'), ('Earphone', 'Earphone'), ('Laptop', 'Laptop'), ('Tablets', 'Tablets'), ('BT Speaker', 'BT Speaker'), ('Smart Watch', 'Smart Watch')], default='Mobile Phone', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
